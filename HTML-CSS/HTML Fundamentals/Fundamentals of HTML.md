...
52.The largest heading is produced by ______ HTML tag.
A. <h1>
B. <h4>
C. <h7>
D. <h9>
...
58.Which of the following is used to add a paragraph to an HTML document?
A. <p>
B. <pg>
C. <pre>
D. <para>
...
59.Which of the following values can be used for the heading tag's align attribute in HTML 5?
A. Left
B. Right
C. Center
...
60.It is suggested that you use h2> to h6> as often as necessary.
...
61.How many times is it OK to use the h1 element in an HTML document?
A. 1
B. 2
C. 3
...
62.Which of the following tags will be used to a content to add a heading?
A. <h1>
B. <p> and <h1>
C. <br> and <p>
D. <hr> and <br>
...
63.The mailto tag is applied for ____
A. Image
B. Email
C. Twitter
D. Faebook
